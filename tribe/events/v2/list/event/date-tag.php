 ...
 * [your-theme]/tribe/events/v2/widgets/calendar-list/event/venue.php
 *
...
<div class="tribe-events-calendar-list__event-date-tag tribe-common-g-col">
	<time class="tribe-events-calendar-list__event-date-tag-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
		<span class="tribe-events-calendar-list__event-date-tag-datetime-wrap">
            <span class="tribe-events-calendar-list__event-date-tag-daynum tribe-common-h2 tribe-common-h4--min-medium">
                <?php echo esc_html( $event_day_num ); ?>
            </span>
            <span class="tribe-events-calendar-list__event-date-tag-month tribe-common-h2 tribe-common-h4--min-medium">
                <?php echo esc_html( $event_month ); ?>
            </span>
        </span>
		<span class="tribe-events-calendar-list__event-date-tag-year tribe-common-h2 tribe-common-h5--min-medium">
			<?php echo esc_html( $event_day_year ); ?>
		</span>
	</time>
    <div class="tribe-events-calendar-list__event-date-tag-categories"><?php echo $event_categories; ?></div>
</div>
